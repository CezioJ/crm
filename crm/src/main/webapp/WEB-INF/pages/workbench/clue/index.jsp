...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#saveCreateClueBtn").click(function (){
			...
			//正则表达式验证
			let pattern = /\S+/;
			if (!(pattern.test(owner)&&pattern.test(fullname)&&pattern.test(company))){
				alert("带*必填");
				return
			}
			//发送请求
				...
				<form class="form-inline" role="form" style="position: relative;top: 8%; left: 5px;">
					...
					<div class="form-group">
						<div class="input-group">
							...
							<select id="query-clueState" class="form-control">
								<option></option>
								<c:forEach items="${clueStateList}" var="cs">
									<option value="${cs.id}">${cs.value}</option>
								</c:forEach>
			...
			<div style="position: relative;top: 50px;">
				<table class="table table-hover">
					...
					<tbody>
						<tr>
							<td><input type="checkbox" /></td>
							<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='workbench/clue/queryClueForDetailById.do?id=9523d7d0a95c4bc8b8aec2f9e4880dca'">点我</a></td>
							<td>动力节点</td>
							<td>010-84846003</td>
							<td>12345678901</td>
							<td>广告</td>
